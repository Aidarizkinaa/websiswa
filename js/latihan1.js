    ...
    // <!-- Memunculkan soal sesudah menonton video -->
$(document).ready(function(){
    $(' #latihanteorisel').hide();

    document.getElementById('vidio').addEventListener('ended', myHandler, false);
    function myHandler(e) {
        $(' #latihanteorisel').show(100);
    }
});
	...
	function cekJawaban(){
        ...
        let jawaban1 = new RegExp('sitoplasma');
    ...
    //isian 2
        ...
        let jawaban2 = new RegExp('protoplasma');
    ...
    //isian 3
        ...
        let jawaban3 = new RegExp('rongga');
    ...
    //isian 4
        ...
        let jawaban4 = new RegExp('biologis');
