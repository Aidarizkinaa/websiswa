...
const firebaseConfig = {
  ...
  appId: "1:769950506546:web:38e0384591f295cd77e62b",
  measurementId: "G-EJ5QJY9RJ6"
};
  // Initialize Firebase
...
dat.onreadystatechange = function () {
    ...
    if (dat.readyState == 4 && dat.status == 200) {
        ...
        var xx =setInterval(function(){
            ...
            localStorage.setItem("nkuis6",hasilakhir);
...
function createTask(sekolah, nama, kelas, nilai, waktunya, hari, jawab) {
    ...
    let database = firebase.database().ref("kuis6/" + counter);
    database.set(task);
